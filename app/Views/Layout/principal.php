  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        ...
        <li class="<?php echo (url_is('/grupos')) ? 'active' : ''; ?>"><a href="<?php echo site_url('/grupos'); ?>">
            <i class="icon-settings"></i>Grupos e Permissões </a>
        </li>
        <li class="<?php echo (url_is('/usuarios/editarSenha')) ? 'active' : ''; ?>">
          <a href="<?php echo site_url('/usuarios/editarSenha'); ?>">
            <i class="icon-settings"></i>Editar Senha
          </a>
        </li>
      </ul>
    </nav>
