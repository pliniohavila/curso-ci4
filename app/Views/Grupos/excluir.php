  ...
  <div class="col-6">
    <div class="block">
      ...
      <div class="block-body">
        ...
        <?php echo form_open_multipart('/grupos/excluir/' . $grupo->id); ?>

        <div class="alert alert-warning" role="alert">
          Tem deseja que excluir o usuário: <strong><?php echo $grupo->nome ?></strong> ?
        </div>

        <input type="submit" value="Excluir" id="btn-danger" class="btn btn-danger w-100 mt-2" />
        <a href="<?php echo site_url("grupos/exibir/$grupo->id"); ?>" class="btn btn-info w-100 mt-2">Cancelar</a>
        </div>
...
<script>
  $(document).ready(function() {
    $('#form').on('submit', function(e) {
      ...
      $.ajax({
        type: 'POST', 
        url: '<?php echo site_url('grupos/upload'); ?>', 
